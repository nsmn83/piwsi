...
3. Wpisz komendę python manage.py makemigrations  (może być wymagane usunięcie starej bazy del db.sqlite3)<br>
4. Wpisz komendę python manage.py migrate
5. Uruchom skrpyt, który wrzuci dane do bazy (na razie zostawilem sqlite3, żeby nie odpalać postgresa lokalnie): python manage.py populate_data<br>
6. Stwórz superusera: python manage.py createsuperuser, najlepiej coś prostego typu username='admin', password='test'<br>
